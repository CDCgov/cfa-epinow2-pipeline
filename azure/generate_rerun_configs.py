...
def main(
    ...
    data_exclusions_path: Annotated[
        str | None,
        typer.Option(
            help=(
                "Path to data exclusions file."
                " Default is to use the report date to generate the path."
                " You almost certainly do not want to change from this default."
            ),
            show_default=False,
        ),
    ] = None,
    ...
    generate_rerun_config(
        ...
        covid_low_count=covid_case_low_count,
        rsv_low_count=rsv_low_case_count,
        flu_low_count=flu_low_case_count,
    )
